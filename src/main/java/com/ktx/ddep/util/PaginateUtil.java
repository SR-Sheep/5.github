...
public class PaginateUtil {
	...
	public static String getPaginate(int pageNo, int total, int numPage, int numBlock, String url) {
		// 현재 페이지 : pageNo 	// 전체 게시물수 : total	// 한 페이지당 게시물수 : numPage
		// 한 페이지당 보여질 블록수 : numBlock 	// 주소 : url
		// 전체 페이지수
		int totalPage = (int) Math.ceil((double) total / numPage);
		// 현재 블록
		int nowBlock = (int) Math.ceil((double) pageNo / numBlock);
	...
	public static String getPaginatePoint(int pageNo, int total, int numPage, int numBlock, String url, String param) {
		//현재 페이지 : pageNo
		//전체 게시물수 : total 
		//한 페이지당 게시물수 : numPage
		//한 페이지당 보여질 블록수 : numBlock
