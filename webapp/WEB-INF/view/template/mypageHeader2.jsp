...
<!-- 마켓 정보가 있고 서비스 지수가 있으면 서비스 지수 박스 보여줌 -->
 <c:if test="${market!=null&&market.serviceIdx!=null}">
...
<div class="service_idx_box box hidden">
    ...
    <div class="star_rate_wrap">
        ...
        <div class="star_rate_lv${6-i}">
            <div class="grade_star star_rate">
                <div class="inner_star star_rate" style="width: ${(6-i)*20}%" ></div>
            </div>
        </div>
    	</c:forEach>
    ...
    <div class="star_idx_wrap">
    	<c:forEach var="i" begin="1" end="5">
        <div class="star_idx_lv${6-i} star_idx">
            <div class="star_graph"></div>
            <span class="star_idx_num"></span>
        </div>
    	</c:forEach>
    </div>
